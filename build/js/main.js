...
.controller('HomeCtrl', ['$scope', '$resource', function($scope, $resource) {
	    ...
	    var Var =  $resource('https://appdrenalin.herokuapp.com/api/users');
		var myr = Var.query(function() {
		$scope.myVar  = myr[2].usersurname;
		});
...
.controller('SidebarCtrl', ['$scope', '$resource', function($scope, $resource) {
	...
	var Var =  $resource('https://appdrenalin.herokuapp.com/api/sports');
	var sports = Var.query(function() {
		$scope.groups = [];
		var i;
